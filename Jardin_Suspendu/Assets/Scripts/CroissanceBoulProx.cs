...
public class CroissanceBoulProx : MonoBehaviour
{
    public Tree t;
    ...
    void TrunkLength()
    {
        xTrunk += growthSpeed;
        yTrunk += growthSpeed;
        xTrunk = Mathf.Clamp(xTrunk, 26.0f, 27.5f);
        yTrunk = Mathf.Clamp(yTrunk, 28.0f, 30.0f);
    ...
    void TrunkRadius()
    {
        ...
        radTrunk = Mathf.Clamp(radTrunk, 2.0f, 2.5f);
